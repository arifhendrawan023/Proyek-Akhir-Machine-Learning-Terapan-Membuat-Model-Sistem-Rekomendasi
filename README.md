...
- Melakukan percobaan dengan memilih pengguna secara acak
   ...
   - Pengguna yang terpilih userId: 177
   ...
   | Affair to Remember, An (1957) | Drama,Romance |
   | Giant (1956) | Drama,Romance,Western |
   | Bringing Up Baby (1938) | Comedy,Romance |
   ...
   | Wings of the Dove, The (1997) | Drama,Romance |
...
- Top-N recommendation nya :
   ...
   TP adalah singkatan dari "True Positives" (Positif Benar), dan FP adalah singkatan dari "False Positives" (Positif Salah). Kedua istilah ini adalah komponen penting dalam evaluasi performa suatu model klasifikasi atau sistem, terutama ketika mengukur kemampuan model untuk mengidentifikasi kelas positif.
   
   Berikut penjelasan singkat tentang keduanya:
   
   True Positives (TP): Ini merujuk pada jumlah kasus yang benar-benar diklasifikasikan sebagai positif oleh model, dan klasifikasinya benar. Dalam konteks sistem rekomendasi film, TP dapat diartikan sebagai jumlah rekomendasi yang dianggap relevan oleh sistem dan memang sesuai dengan preferensi pengguna.
   
   False Positives (FP): Ini merujuk pada jumlah kasus yang salah diklasifikasikan sebagai positif oleh model, padahal seharusnya bukan. Dalam konteks sistem rekomendasi film, FP dapat diartikan sebagai jumlah rekomendasi yang dianggap relevan oleh sistem, tetapi ternyata tidak sesuai dengan preferensi pengguna.
   
   Rumus precision digunakan untuk mengukur seberapa akurat sistem atau model dalam mengidentifikasi kasus positif (dalam konteks ini, rekomendasi yang sesuai dengan preferensi pengguna) dibandingkan dengan total kasus yang diklasifikasikan sebagai positif oleh sistem (yaitu, TP + FP). Semakin tinggi nilai precision, semakin baik sistem dalam memberikan rekomendasi yang relevan.

  Berdasarkan data uji diatas

  Precision = (TP) / (TP + FP) = 5/5+0 = 1 atau 100%
...
### Hasil Evaluasi Collaborative Filtering
   ...
   loss: 0.5961 - root_mean_squared_error: 0.1868 - val_loss: 0.6082 - val_root_mean_squared_error: 0.1997
   ...
   Dari proses ini, kita memperoleh nilai error akhir sebesar sekitar 0.1868 dan error pada data validasi sebesar 0.1997

## Kesimpulan

Berdasarkan hasil Content Based Filtering dan Collaborative Filtering dapat melakukan rekomendasi dengan baik. Content Based Filtering di uji dengan precision menghasilkan nilai 100% yaitu akurat sedangkan Collaborative Filtering di uji dengan RMSE memperoleh nilai error akhir sebesar sekitar 0.1868 dan error pada data validasi sebesar 0.1997. Karena nilai RMSE mendekati 0 maka dikatakan cukup baik dan berdasarkan hasil uji rekomendasi juga cukup akurat hasil yang di rekomendasikan. Penggunaan model Collaborative Filtering atau Content Based Filtering dapat digunakan untuk sistem rekomendasi film
